...
TECHNO_IMG = "https://telegra.ph/file/9540d1c2ffc02945cfaac.jpg"
IMPORTED = {}
MIGRATEABLE = []
HELPABLE = {}
STATS = []
...
def start(bot: Bot, update: Update, args: List[str]):
    if update.effective_chat.type == "private":
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="🤝HELP🤝",
                                                                       ...
                                                                       url="t.me/opHackerrrrrrrrrr")],
                                                                                   [InlineKeyboardButton(text="ADD 😈ŌमेNTaL๛Op👑 OFFICIAL TO YOUR GROUP",
        ...
        update.effective_message.reply_text("ZINDA HOON⚡")
